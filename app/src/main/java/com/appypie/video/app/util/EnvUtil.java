...
public class EnvUtil {
    ...
    public static String getNativeEnvironmentVariableValue(String environment) {
        if (environment != null) {
            if (environment.equals(com.appypie.video.app.webservices.TwilioApiEnvironmentKt.TWILIO_API_DEV_ENV)) {
                return TWILIO_DEV_ENV;
            } else if (environment.equals(com.appypie.video.app.webservices.TwilioApiEnvironmentKt.TWILIO_API_STAGE_ENV)) {
