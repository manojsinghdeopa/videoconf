...
class RoomViewModel(private val roomManager: RoomManager, private val audioDeviceSelector: AudioDeviceSelector) : ViewModel() {
    ...
    private fun connect(identity: String, roomName: String, isNetworkQualityEnabled: Boolean) {
        roomManager.connectToRoom(identity, roomName, isNetworkQualityEnabled)
    }
    ...
    class RoomViewModelFactory(private val roomManager: RoomManager,
                               private val audioDeviceSelector: AudioDeviceSelector) : ViewModelProvider.Factory {
